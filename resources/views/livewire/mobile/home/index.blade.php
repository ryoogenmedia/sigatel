            ...
            <div class="row">
                    ...
                    <div class="card project-total-card">
                        <div class="card-body">
                            <div class="d-flex position-relative">
                                <h5 class="text-dark txt-ellipsis-1">
                                    Total Hours
                                </h5>
                                <div class="clock-box">
                                    <div class="clock">
                ...
                <div class="col-sm-6">
                    <div class="card bg-info-300 project-details-card">
                        <div class="card-body">
                            ...
                            <div class="my-4">
                                <h5 class="f-w-600 text-info-dark txt-ellipsis-1">
                                    Project Alpha
                                </h5>
                                <p class="text-info f-s-13 txt-ellipsis-1 mb-0">
                                    Revolutionizing ideas, empowering innovation, and
                                    driving success.
                                </p>
                            </div>
                ...
                <div class="col-sm-6">
                    <div class="card bg-success-300 project-details-card">
                        <div class="card-body">
                            ...
                            <div class="my-4">
                                <h5 class="f-w-600 text-success-dark txt-ellipsis-1">
                                    Project Beta
                                </h5>
                                <p class="text-success f-s-13 txt-ellipsis-1 mb-0">
                                    Innovating solutions for seamless task management
                                    efficiency.
                                </p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between pt-3">
                ...
                <div class="col-sm-6">
                    <div class="card core-teams-card">
                        <div class="card-body">
                            <div class="d-flex">
                                <h5 class="text-dark f-w-600 txt-ellipsis-1">
                                    💼 Core Teams
                                </h5>
                            </div>
                            <div>
                                <h2 class="text-warning-dark my-4 d-inline-flex align-items-baseline">
                                    1k
            ...
            <div class="card project-connect-card">
                <div class="card-body pb-0">
                    <div class="text-center">
                        <h5 class="mb-2 f-s-24">
                            Get started
                            <span class="text-primary f-w-700">Effortlessly.</span>
                        </h5>
                        <p class="f-s-14 text-dark pb-0 txt-ellipsis-2">
                            Connect your team's tools and unlock a unified view of
                            every project's progress, deadlines, and team
                            contributions.
                        </p>
                    </div>
            ...
            <div class="card">
                <div class="card-body position-relative">
                    <div class="time-tracker">
                        <div class="share-time">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end rounded">
                                    <li>
                                        <a class="dropdown-item f-s-14" href="#"><i
                        ...
                        <div class="controls">
                            <button class="btn btn-light-primary icon-btn b-r-18" id="start-btn">
                                <i class="iconoir-play-solid"></i>
                            </button>
                            <button class="btn btn-danger icon-btn b-r-18" disabled id="stop-btn">
                    ...
                    <ul class="tracker-history-list app-scroll mt-3">
                        <li class="bg-info-300">
                            ...
                            <div class="text-dark f-w-600 ms-2">00:01:23</div>
                        </li>
                    ...
                    <div class="table-responsive app-scroll">
                        <table class="table align-middle project-status-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <h6 class="mb-0 text-success-dark text-nowrap">
                                            Web Redesign
                                        </h6>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="text-dark f-s-14 f-w-500 text-nowrap"><i
                                                class="ti ti-circle-filled me-2 f-s-6"></i>
                                            Design phase completed</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h6 class="mb-0 text-warning-dark text-nowrap">
                                            Mobile App
                                        </h6>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="text-dark f-s-14 f-w-500 text-nowrap"><i
                                                class="ti ti-circle-filled me-2 f-s-6"></i>
                                            Project deployed successfully</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <span class="text-dark f-s-14 f-w-500 text-nowrap"><i
                                                class="ti ti-circle-filled me-2 f-s-6"></i>
                                            Campaign to begin in December</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h6 class="mb-0 text-primary-dark text-nowrap">
                                            E-Commerce
                                        </h6>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-dark f-s-14 f-w-500 text-nowrap">
                                            <i class="ti ti-circle-filled me-2 f-s-6"></i>
                ...
                <div class="card-body">
                    <div class="task-container slider">
                        <div class="card task-card bg-danger-300">
                            <div class="card-body">
                                <h6 class="text-danger-dark txt-ellipsis-1">
                        ...
                        <div class="card task-card bg-warning-300">
                            <div class="card-body">
                                <h6 class="text-warning-dark txt-ellipsis-1">
                        ...
                        <div class="card task-card bg-info-300">
                            <div class="card-body">
                                <h6 class="text-info-dark txt-ellipsis-1">
                        ...
                        <div class="card task-card bg-success-300">
                            <div class="card-body">
                                <h6 class="text-success-dark txt-ellipsis-1">
                                    Test User Feedback
                                </h6>
                                <ul class="avatar-group justify-content-start my-3">
                                    <li class="h-35 w-35 d-flex-center b-r-50 overflow-hidden bg-primary">
