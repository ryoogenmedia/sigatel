<div class="container-fluid">
    <x-mobile.title-page title="Sunting Pelanggaran Siswa" subtitle="Menyunting Pelanggaran Siswa." />
                ...
                <div class="card-body px-3">
                    ...
                    <div class="card border">
                        ...
                        <div class="card-footer">
                            <div class="col-12">
                                <button wire:click="edit" type="submit" class="btn btn-primary-dark w-100">Berikan
                                    Tugas</button>
                            </div>
                        </div>
                    </div>
