            ...
            <table class="table card-table table-bordered datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <x-datatable.column-sort name="Nama Lengkap" wire:click="sortBy('username')"
                        ...
                        <th>
                            <x-datatable.column-sort name="Level" wire:click="sortBy('roles')" :direction="$sorts['roles'] ?? null" />
                        </th>
