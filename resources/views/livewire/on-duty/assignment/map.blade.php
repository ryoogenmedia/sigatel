...
<div>
    <x-slot name="title">Lokasi Penugasan</x-slot>

    <x-slot name="pagePretitle">Lokasi Penugasan</x-slot>

    <x-slot name="pageTitle">Tambahkan Lokasi Penugasan</x-slot>
    ...
    @unless (session('alert'))
        @if (!$this->onDutyLocation['latitude'] && !$this->onDutyLocation['longitude'])
