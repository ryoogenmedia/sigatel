<div>
    ...
    <div class="row g-2 align-items-center mb-4">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a href="{{ route('print-report.student-parent', ['date_start' => $this->filters['date_start'] ?? '', 'date_end' => $this->filters['date_end'] ?? '']) }}"
                    target="_blank" class="btn btn-danger" class="btn btn-danger"><span
                        class="las la-print fs-1 me-2"></span>Cetak Orang Tua Siswa</a>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3 align-items-center justify-content-between">
        <div class="col-12 col-lg-5 d-flex">
            ...
            <div class="w-50 ms-2">
                <x-datatable.filter.button target="report-student-parent" />
            </div>
        </div>
    ...
    <x-datatable.filter.card id="report-student-parent">
        <div class="row">
                ...
                <tbody>
                    @forelse ($this->rows as $row)
                        <tr wire:key="row-{{ $row->id }}">
                            ...
                            <td>{{ ucwords($row->guardian_status ?? '-') }}</td>
                        </tr>
                    @empty
