<div>
    ...
    <x-modal :show="$show" size="md">
        <form wire:submit.prevent="importExcel" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <p>unduh template import excel siswa <a href="/template/file-excel-siswa.xlsx">disini</a></p>
            </div>
    ...
    <div class="row mb-3 align-items-center justify-content-between">
        <div class="col-12 col-lg-5 d-flex">
            ...
            <div class="w-50 ms-2">
                <x-datatable.filter.button target="student" />
            </div>
        </div>
    ...
    <x-datatable.filter.card id="student">
        <div class="row">
