...
<div>
    <x-slot name="title">Sunting Penugasan Kelas</x-slot>

    <x-slot name="pagePretitle">Menyunting Data Penugasan Kelas</x-slot>

    <x-slot name="pageTitle">Sunting Penugasan Kelas</x-slot>
